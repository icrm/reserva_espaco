...
# Rails core
gem 'rails', '3.2.3'
# Postgres gem para conexão com o banco de dado postgres
gem 'pg', '0.12.2'
# Biblioteca Javascript/CSS para layout e funcionalidades no estilo twitter
gem 'bootstrap-sass', '2.0.0'
# Biblioteca para geração de senhas criptografadas
gem 'bcrypt-ruby', '3.0.1'
# Biblioteca Javascript jQuery
gem 'jquery-rails', '2.0.0'

group :development do
  # Cria comentários de anotação das classes
